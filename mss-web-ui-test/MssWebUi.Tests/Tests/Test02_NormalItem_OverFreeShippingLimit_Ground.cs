...
{
    public class Test02_NormalItem_OverFreeShippingLimit_Ground : BaseBrowserFixture
    {
        private const string ProductSize = "Medium", LastName = "Normal Over Ground";
        private const int TotalQuantity = 10;
        ...
        public void TestMyUseCaseTwo()
        {
            ...
            cartPage.WaitForPriceToGetUpdated(SplitAndConvert(_productPrice, 1) * TotalQuantity);
            ...
            Assert.AreEqual((TotalQuantity*Int32.Parse(_rewardPoints)),
                Int16.Parse(cartPage.GetTotalRewardPointsInCartPage(_rewardPoints)),
                "Reward points are not matching.");
            ...
            Assert.True(shippingBillingPage.IsOvernightFreeShippingPresent(),
                "Overnight Shipping option is not present.");
            shippingBillingPage.WaitForElement(By.Id("shipping-option-Two Day Upgrade"), 10);
            Assert.True(shippingBillingPage.IsTwoDayFreeShippingPresent(), "Two Day Shipping option is not present.");
