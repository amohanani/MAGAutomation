...
{
    public class Test20_KY_OversizeItem_OverFreeShippingLimit_Ground : BaseBrowserFixture
    {
        ...
        [Test]
        public void TestMyUseCaseTwenty()
        {
            ...
            shippingBillingPage.WaitForElement(By.Id("shipping-option-Free Ground"), 20);
